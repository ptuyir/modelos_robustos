...
ancova_errot <- stan("/MODELOS USADOS/ancova_errot_simulacao.stan",
...
saveRDS(ancova_errot,file="/modelos_erro_t/result_simulacao_ancova_t.rds")
saveRDS(dados_simulados,file="/modelos_erro_t/dados_simulados_ancova_t.rds")
...
ancova_errot <- stan("/MODELOS USADOS/ancova_errot_choy.stan",
                     data=list(X_alpha=X_a,X_beta=X_b,Y=Y,K_beta=K,N=N,X_alpha_prev=X_b_prev,X_beta_prev=X_a_prev,
                               K_beta_prev=K_prev,N_prev=N_prev),
                     warmup=10000,iter=40000,thin=50,
                     chains=2, control=list(adapt_delta=0.99),cores = getOption("mc.cores", 2))  
...
saveRDS(ancova_errot,file="/modelos_erro_t/result_choy_ancova_t.rds")
...
saveRDS(ancova_errot,file="/modelos_erro_t/result_cote_ancova_t.rds")
...
saveRDS(ancova_errot,file="/modelos_erro_t/result_soa_ancova_t.rds")
