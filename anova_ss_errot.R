...
anova_errot_ss <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ss_anova_errot_simulacao.stan",
                        data=data_list,
...
saveRDS(anova_errot_ss,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_t/simulacao_anova_ss_errot.rds")
saveRDS(dados_simulados,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_t/dados_simulados_anova_ss_errot.rds")
...
## rodando o modelo no stan
anova_errot_ss <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ss_anova_errot.stan",
                        data=data_list,
                        warmup=150000,iter=300000,thin=50,
                        chains=2, control=list(adapt_delta=0.99),cores = getOption("mc.cores", 2))  
...
saveRDS(anova_errot_ss,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_t/result_choy_ss_errot.rds")
...
## SALVANDO RESULTADO DO MODELO 
saveRDS(anova_errot_ss,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_t/result_cote_ss_errot.rds")
...
## SALVANDO RESULTADO DO MODELO 
saveRDS(anova_errot_ss,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_t/result_soa_ss_errot.rds")
