...
ancova_normal <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ancova_normal_simulado.stan",
...
saveRDS(ancova_normal,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal//result_simulacao_ancova_normal.rds")
saveRDS(dados_simulados,file="/home//Pessoal/Modelos_tcc_teste_validation/dados_simulados_ancova_normal.rds")
...
## rodando o modelo no stan
ancova_normal <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ancova_normal_choy.stan",
                      data=list(X_alpha=X_a,X_beta=X_b,Y=Y,K_beta=K,N=N,X_alpha_prev=X_b_prev,X_beta_prev=X_a_prev,
                                K_beta_prev=K_prev,N_prev=N_prev),
                      warmup=10000,iter=40000,thin=50,
                      chains=2, control=list(adapt_delta=0.99),cores = getOption("mc.cores", 2))
...
saveRDS(ancova_normal,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal//result_choy_ancova_normal.rds")
...
saveRDS(ancova_normal,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_cote_ancova_normal.rds")
...
View(extract(ancova_normal)$y_new)
y_novo<-apply(y_new,MARGIN=2,FUN=median)
saveRDS(ancova_normal,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_soa_ancova_normal.rds")
