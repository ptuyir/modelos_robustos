...
anova_slash <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/anova_slash_simulacao.stan",
...
saveRDS(anova_slash,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_simulacao_anova_slash.rds")
saveRDS(dados_simulados,file="/home//Pessoal/Modelos_tcc_teste_validation/dados_simulados_anova_slash.rds")
...
anova_slash <- stan("/home//Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/anova_slash_choy.stan",
                data=list(X_alpha=X_a,X_beta=X_b,Y=Y,K_alpha=K,K_beta=K,N=N,X_alpha_prev=X_a_prev,
                          X_beta_prev=X_b_prev, K_alpha_prev=K_prev,N_prev=N_prev,K_beta_prev=K_prev),
                warmup=10000,iter=40000,thin=50,chains=2, control=list(adapt_delta=0.99),
                cores = getOption("mc.cores", 2))  
...
saveRDS(anova_slash,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_choy_anova_slash.rds")
...
saveRDS(anova_slash,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_cote_anova_slash.rds")
...
saveRDS(anova_slash,file="/home//Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_soa_anova_slash.rds")
